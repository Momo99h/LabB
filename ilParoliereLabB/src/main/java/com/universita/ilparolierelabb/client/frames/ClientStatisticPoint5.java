 ...
 * @author Momo
 */
public class ClientStatisticPoint5 extends JDialog {

    
    private DefaultTableModel _tableModel = new DefaultTableModel(new String[] {"Players","Min rounds","Max rounds"},0);
    public ClientStatisticPoint5(java.awt.Frame parent, boolean modal) 
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("5) Min and Max rounds for players in room");
    ...
    {
        ClientStatisticPoint5 form = new ClientStatisticPoint5(new javax.swing.JFrame(), true);
        form.loadData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientStatisticPoint5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    {
        String[][] x = ClientManager.getStatisticPoint5();
        for(int i = 0; i < x.length; i++)
        {
            _tableModel.addRow(new String[]{x[i][2],x[i][0],x[i][1]});
        }
