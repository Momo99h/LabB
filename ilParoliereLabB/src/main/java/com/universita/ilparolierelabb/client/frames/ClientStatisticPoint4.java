 ...
 * @author Momo
 */
public class ClientStatisticPoint4 extends JDialog {

    
    private DefaultTableModel _tableModel = new DefaultTableModel(new String[] {"Players","Avarage rounds"},0);
    public ClientStatisticPoint4(java.awt.Frame parent, boolean modal) 
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("4) Average round for players in room");
    ...
    {
        ClientStatisticPoint4 form = new ClientStatisticPoint4(new javax.swing.JFrame(), true);
        form.loadData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientStatisticPoint4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    {
        String[][] x = ClientManager.getStatisticPoint4();
        for(int i = 0; i < x.length; i++)
        {
            _tableModel.addRow(new String[]{x[i][1],x[i][0]});
        }
