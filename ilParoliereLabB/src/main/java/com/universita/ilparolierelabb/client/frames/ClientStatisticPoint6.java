 ...
 * @author Momo
 */
public class ClientStatisticPoint6 extends JDialog {

    
    private DefaultTableModel _tableModel = new DefaultTableModel(new String[] {"Letter","Occurency"},0);
    public ClientStatisticPoint6(java.awt.Frame parent, boolean modal) 
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("6) Letters occurency");
    ...
    {
        ClientStatisticPoint6 form = new ClientStatisticPoint6(new javax.swing.JFrame(), true);
        form.loadData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientStatisticPoint6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    {
        String[][] x = ClientManager.getStatisticPoint6();
